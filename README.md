...
* This script includes [pimpmynode](https://github.com/TeelaBrown/pimpmynode) by AKcryptoGUY and TeelaBrown. It will modify the VPS welcome message. If you don't want this, there is a 'vanilla' version of Nodemaster for Securus here: https://github.com/trollboxteela/vps
...
A script for starting all masternodes on the VPS has been created at /usr/local/bin/activate_masternodes_securus.sh.
